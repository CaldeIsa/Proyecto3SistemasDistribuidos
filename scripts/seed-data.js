    ...
    const artistas = [
      {
        ...
        biografia: 'Leonardo da Vinci fue un polímata del Renacimiento italiano. Destacó como pintor, anatomista, arquitecto, paleontólogo, artista, botánico, científico, escritor, escultor, filósofo, ingeniero, inventor, músico, poeta y urbanista.',
      ...
      },
      {
        ...
        biografia: 'Vincent Willem van Gogh fue un pintor neerlandés, uno de los principales exponentes del postimpresionismo. Pintó unos 900 cuadros y realizó más de 1600 dibujos.',
      ...
      },
      {
        ...
        biografia: 'Pablo Ruiz Picasso fue un pintor y escultor español, creador, junto con Georges Braque, del cubismo. Es considerado uno de los mayores artistas del siglo XX.',
      ...
      },
      {
        ...
        biografia: 'Edvard Munch fue un pintor y grabador noruego. Sus evocativas obras sobre la angustia influyeron profundamente en el expresionismo alemán de comienzos del siglo XX.',
      ...
      },
      {
        ...
        biografia: 'Gustav Klimt fue un pintor simbolista austriaco, y uno de los más conspicuos representantes del movimiento modernista de la secesión vienesa.',
      ...
      },
      {
        ...
        nacionalidad: 'Neerlandés',
        biografia: 'Johannes Vermeer fue un pintor neerlandés especializado en escenas domésticas de la vida burguesa. Reconocido por su maestría en el tratamiento y representación de la luz.',
    ...
    const museos = [
      {
        ...
        pais: 'Francia',
        fundacion: '1793',
        descripcion: 'El Museo del Louvre es el museo nacional de Francia consagrado al arte anterior al impresionismo. Es uno de los más importantes del mundo.',
      ...
      },
      {
        ...
        pais: 'Estados Unidos',
        fundacion: '1929',
        descripcion: 'El Museo de Arte Moderno de Nueva York es un museo de arte moderno y contemporáneo ubicado en Midtown Manhattan, Nueva York.',
      ...
      },
      {
        ...
        pais: 'España',
        fundacion: '1819',
        descripcion: 'El Museo Nacional del Prado es uno de los más importantes del mundo, así como el más visitado de los dedicados al arte en España.',
      ...
      },
      {
        ...
        pais: 'España',
        fundacion: '1992',
        descripcion: 'El Museo Nacional Centro de Arte Reina Sofía es el museo nacional español de arte del siglo XX y contemporáneo.',
      ...
      },
      {
        ...
        pais: 'Italia',
        fundacion: '1581',
        descripcion: 'La Galería Uffizi es un palacio y museo en Florencia, Italia. Es uno de los museos más antiguos y famosos del mundo.',
      ...
      },
      {
        ...
        pais: 'Países Bajos',
        fundacion: '1822',
        descripcion: 'El Mauritshuis es un museo de arte ubicado en La Haya, Países Bajos. Alberga la Colección Real de Pinturas.',
    ...
    const pinturas = [
      {
        ...
        descripcion: 'La Gioconda, también conocida como La Mona Lisa, es una obra pictórica del renacentista italiano Leonardo da Vinci.',
      ...
      },
      {
        ...
        descripcion: 'La Última Cena es una pintura mural original de Leonardo da Vinci ejecutada entre 1495 y 1498.',
      ...
      },
      {
        ...
        descripcion: 'Los girasoles es una serie de cuadros al óleo realizados por el pintor Vincent van Gogh.',
      ...
      },
      {
        ...
        titulo: 'El Grito',
        anio: '1893',
        tecnica: 'Óleo, temple, pastel y caseína sobre cartón',
        dimensiones: '91 cm × 73.5 cm',
        descripcion: 'El grito es el título de cuatro cuadros del noruego Edvard Munch. La versión más famosa se encuentra en la Galería Nacional de Noruega.',
      ...
      },
      {
        ...
        descripcion: 'Las meninas es la obra maestra del pintor del Siglo de Oro español Diego Velázquez.',
      ...
      },
      {
        ...
        descripcion: 'El beso es una obra del pintor austríaco Gustav Klimt, pintada entre 1907 y 1908.',
      ...
      },
      {
        ...
        descripcion: 'La joven de la perla es una de las obras maestras del pintor neerlandés Johannes Vermeer.',
      ...
      },
      {
        ...
        descripcion: 'El nacimiento de Venus es una pintura de Sandro Botticelli. Representa una de las obras más famosas del artista.',
      ...
      },
      {
        ...
        descripcion: 'La creación de Adán es un fresco en el techo de la Capilla Sixtina, pintado por Miguel Ángel.',
      ...
      },
      {
        ...
        descripcion: 'La persistencia de la memoria es un famoso cuadro del pintor español Salvador Dalí.',
